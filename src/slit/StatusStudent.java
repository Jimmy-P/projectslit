...
public class StatusStudent extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        */
        ...
        VBox vb5 = new VBox();
        vb1.getChildren().addAll(lblMod5, btnMod5, dateMod5);
        VBox vb6 = new VBox();
        vb1.getChildren().addAll(lblMod6, btnMod6, dateMod6);
        VBox vb7 = new VBox();
        vb1.getChildren().addAll(lblMod7, btnMod7, dateMod7);
        VBox vb8 = new VBox();
        vb1.getChildren().addAll(lblMod8, btnMod8, dateMod8);
        VBox vb9 = new VBox();
        vb1.getChildren().addAll(lblMod9, btnMod9, dateMod9);
        VBox vb10 = new VBox();
        vb1.getChildren().addAll(lblMod10, btnMod10, dateMod10);
        VBox vb11 = new VBox();
        vb1.getChildren().addAll(lblMod11, btnMod11, dateMod11);
        VBox vb12 = new VBox();
        vb1.getChildren().addAll(lblMod12, btnMod12, dateMod12);
        VBox vb13 = new VBox();
        vb1.getChildren().addAll(lblMod13, btnMod13, dateMod13);
        VBox vb14 = new VBox();
        vb1.getChildren().addAll(lblMod14, btnMod14, dateMod14);
